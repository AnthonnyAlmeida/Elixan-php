...
<section class="benefits">
  <div class="benefit">
    ...
    <h2 data-key="home_benefit1_title">100% NATÜRLICH &amp; VEGAN</h2>
    <p data-key="home_benefit1_text">Reine ätherische Öle ohne synthetische Zusätze.</p>
  </div>
  <div class="benefit">
    <div class="icon"><i class="fas fa-flag-checkered"></i></div>
    <h2 data-key="home_benefit2_title">SCHWEIZER QUALITÄT</h2>
    <p data-key="home_benefit2_text">GMP-zertifiziert, entwickelt und abgefüllt in der Schweiz.</p>
  </div>
  <div class="benefit">
    <div class="icon"><i class="fas fa-euro-sign"></i></div>
    <h2 data-key="home_benefit3_title">PASSIVES EINKOMMEN</h2>
    <p data-key="home_benefit3_text">Bis zu 30 % Provision + Team-Boni – flexibel und ortsunabhängig.</p>
  </div>
</section>
